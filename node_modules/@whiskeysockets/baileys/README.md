...
```
Isso permite que a pessoa/grupo com ``` id ``` saiba se você está online, offline, digitando etc. 

``` presença ``` pode ser um dos seguintes:
``` ts
...
**Observação:** Na versão multidispositivo do WhatsApp -- se um cliente de desktop estiver ativo, o WA não envia notificações push para o dispositivo. Se você quiser
